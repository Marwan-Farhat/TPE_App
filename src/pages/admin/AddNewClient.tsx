...
const AddNewClient = () => {
  ...
  const onSubmit = async (data: ClientFormData, saveAndAddAnother: boolean = false) => {
    ...
    try {
      ...
      const missingMandatory = extraFields.filter((f) => f.isMandatory && !extraFieldValues[f.id]);
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit((data) => onSubmit(data, false))}>
                ...
                <Card className="overflow-hidden mb-6">
                  <CardHeader className="bg-admin-section-alt border-b border-admin-border-light">
                    <h2 className="text-lg font-semibold flex items-center gap-2 text-primary">
                      ...
                      {t("admin.clientForm.personalInfo")}
                    </h2>
                  </CardHeader>
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              {...field}
                              placeholder={t("admin.clientForm.placeholders.jobTitle")}
                              className={isRTL ? "text-right" : ""}
                            />
                          </FormControl>
                        </FormItem>
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              {...field}
                              placeholder={t("admin.clientForm.placeholders.city")}
                              className={isRTL ? "text-right" : ""}
                            />
                          </FormControl>
                        </FormItem>
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              {...field}
                              placeholder={t("admin.clientForm.placeholders.country")}
                              className={isRTL ? "text-right" : ""}
                            />
                          </FormControl>
                        </FormItem>
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              {...field}
                              type="tel"
                              placeholder={t("admin.clientForm.placeholders.guardianNumber")}
                              className={isRTL ? "text-right" : ""}
                            />
                          </FormControl>
                        </FormItem>
                ...
                <Collapsible open={isEnrollmentDetailsOpen} onOpenChange={setIsEnrollmentDetailsOpen}>
                  <Card className="overflow-hidden mb-6">
                    <CollapsibleTrigger className="w-full">
                      <CardHeader className="bg-admin-section-alt border-b border-admin-border-light hover:bg-muted/50 transition-colors">
                        <div className="flex items-center justify-between">
                          <h2 className="text-lg font-semibold flex items-center gap-2 text-primary">
                            <Settings className="h-5 w-5" />
                            {t("admin.clientForm.productInfo")}
                          </h2>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea {...field} placeholder={t("admin.clientForm.placeholders.notes")} rows={4} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <div className="flex items-center gap-4">
                  <Button type="submit" disabled={isSubmitting || !isFormValid} className="gap-2">
                    <UserPlus className="h-4 w-4" />
