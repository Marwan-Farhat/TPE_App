 ...
 import { TaskCategory, TaskUrgency, CreateTaskPayload } from "@/types/staffTask";
 ...
 const CreateTaskDialog: React.FC<CreateTaskDialogProps> = ({
  ...
  const tTask = (key: string, options?: any) => t(`admin.staffTasks.${key}`, options) as string;
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
           ...
           <div className="space-y-4">
             ...
             <div className="space-y-2">
               ...
               <div className="flex gap-2">
                 ...
                 <Button
                   ...
                   size="sm"
                   onClick={() => {
                     const currentUser = teamMembers.find((m) => m.id === "current-user");
                     if (currentUser) setAssignedTo(currentUser.id);
                     else if (teamMembers.length > 0) setAssignedTo(teamMembers[0].id);
                   }}
                 >
                    {tTask("me")}
                 </Button>
               ...
               <Select value={urgency} onValueChange={(v) => setUrgency(v as TaskUrgency)}>
                 ...
                 <SelectContent>
                   <SelectItem value="critical">
                      {tTask("urgencyCritical")}
                   </SelectItem>
                   <SelectItem value="important">
                      {tTask("urgencyImportant")}
                   </SelectItem>
             ...
             <div className="flex items-center gap-2">
               ...
               />
               <Label htmlFor="allow-reassign" className="text-sm font-normal cursor-pointer">
                  {tTask("allowReassign")}
               </Label>
             </div>
           </div>
               ...
               <div className="p-3 border rounded-lg bg-muted/50">
                 <div className="flex items-center justify-between">
                   <div>
                     ...
                     <p className="text-xs text-muted-foreground">{clientCode}</p>
                   </div>
